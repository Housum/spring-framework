...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    /**
     * 解析NamespaceHandler 非常重要 是Spring中实现各种命名空间的的基础
    ...
    /**
     * 这里需要添加BeanDefinitionRegistry BeanDefinitionRegistry的指责有
     * 两个 一个是注册BeanDefinition 一个是注册别名(AliasRegistry)
     *
     *
    ...
    protected NamespaceHandlerResolver createDefaultNamespaceHandlerResolver() {
        //创建一个默认的NamespaceHandlerResolver
